...
export const companies: Record<string, CompanyConfig> = {
  little_plains: {
    ...
    featuredProjects: ['caresignal-ai', 'caresignal-brand'],
    salutation_colors: {
      foreground_color: '#FFFFFF',
      background_color: '#0398fa',
    },
    seal: {
      foreground_color: 'rgb(0, 33, 66)',
      background_color: 'rgb(255, 234, 2)',
    },
    role: 'de',
  },
  thatch: {
  ...
  maven_clinic: {
    ...
    featuredSlugs: ['caresignal-platform', 'caresignal-brand', 'caresignal-ai', 'sqshbook', 'fracta'],
    featuredProjects: ['caresignal-platform', 'caresignal-brand'],
    role: 'pd',
  },
  counsel_health: {
